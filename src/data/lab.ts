export const caseCompany = {
  ...
  yearEnd: "3月決算",
  actuals: [
    { year: "FY2024実績", revenue: 1000, ebitda: 140 },
    { year: "FY2025実績", revenue: 1100, ebitda: 165 },
  ],
  forecastYears: ["FY2026", "FY2027", "FY2028", "FY2029", "FY2030"],
...
export const roadmapSteps = [
  ...
  { no: 2, title: "モデル構造とシート設計", goal: "入力・計算・出力・チェックを分けたモデル骨格を作る", prerequisite: "Excelの四則演算とシート参照", time: "2時間", href: "/model-design", file: "02_前提条件入力.xlsx", done: "Inputs、Assumptions、PL、BS、CF、Checksの役割を分けられる" },
...
export const qualityCriteria = [
  ...
  { area: "可読性・引継ぎやすさ", points: 10, checks: ["Guideシートや注記がある", "レビュー者が前提と計算の出所を追える"] },
];
...
export const journalEntries = [
  ...
  { title: "固定資産取得と減価償却", transaction: "設備を200で取得し、年間40を減価償却した。", debit: "機械装置 200 / 減価償却費 40", credit: "普通預金 200 / 減価償却累計額 40", impact: "PLは減価償却費+40。BSは固定資産純額+160、現金-200。CFは減価償却費を営業CFで加算、設備投資を投資CFで控除。", excel: "Schedules!H40、PL!H35、BS!H30、CF!H24、CF!H32", caution: "減価償却費は非資金費用としてCFで足し戻す。" },
  { title: "借入と支払利息", transaction: "借入金300を実行し、利息9を計上、うち1は未払。", debit: "普通預金 300 / 支払利息 9", credit: "借入金 300 / 普通預金 8 / 未払利息 1", impact: "PLは支払利息+9。BSは現金+292、借入金+300、未払利息+1。CFは借入を財務CF、利息を営業CFまたは財務CF方針に従い表示。", excel: "Schedules!H60、PL!H42、BS!H55、CF!H42", caution: "平均借入残高と金利で利息を計算し、未払分をBSへ残す。" },
